...
public final class Util {
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        String host;
        if (httpUrl.host().contains(QuickSettingConstants.JOINER)) {
            host = "[" + httpUrl.host() + "]";
        } else {
            host = httpUrl.host();
        }
        return (z || httpUrl.port() != HttpUrl.defaultPort(httpUrl.scheme())) ? host + QuickSettingConstants.JOINER + httpUrl.port() : host;
    }
