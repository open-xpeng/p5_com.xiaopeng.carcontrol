...
public class DoorKeySettingPageAction implements PageAction {
    @Override // com.xiaopeng.carcontrol.direct.action.PageAction
    public void doAction(Context context, Uri uri) {
        ControlPanelManager.getInstance().show(GlobalConstant.ACTION.ACTION_SHOW_CUSTOM_DOOR_KEY_PANEL, 2048);
    }
}
