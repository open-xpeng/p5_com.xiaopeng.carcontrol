...
public class ApiRouterUnitySceneService_Stub extends Binder implements IInterface {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        if (i == 0) {
            parcel.enforceInterface(ApiRouterUnitySceneService_Manifest.DESCRIPTOR);
            ...
            if (i == 1598968902) {
                parcel2.writeString(ApiRouterUnitySceneService_Manifest.DESCRIPTOR);
                return true;
            }
            ...
            try {
                this.provider.onVuiQuery((String) TransactTranslator.read(uri3.getQueryParameter(NotificationCompat.CATEGORY_EVENT), "java.lang.String"), (String) TransactTranslator.read(uri3.getQueryParameter("data"), "java.lang.String"));
                parcel2.writeNoException();
                TransactTranslator.reply(parcel2, null);
                return true;
            } catch (Exception e3) {
