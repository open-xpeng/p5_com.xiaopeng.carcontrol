...
import com.xiaopeng.carcontrol.VuiUnityObserver;
import com.xiaopeng.speech.vui.constants.VuiConstants;

/* loaded from: classes2.dex */
public class VuiUnityObserver_Stub extends Binder implements IInterface {
    public VuiUnityObserver provider = new VuiUnityObserver();
    public VuiUnityObserver_Manifest manifest = new VuiUnityObserver_Manifest();
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        if (code == 0) {
            data.enforceInterface(VuiUnityObserver_Manifest.DESCRIPTOR);
            ...
            if (code == 1598968902) {
                reply.writeString(VuiUnityObserver_Manifest.DESCRIPTOR);
                return true;
            }
