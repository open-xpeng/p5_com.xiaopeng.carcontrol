...
public class XIdSPUtils {
    private static volatile XIdSPUtils sInstance;
    private SharedPreferences mPrefs;

    private XIdSPUtils() {
    }

    public static XIdSPUtils getInstance() {
        if (sInstance == null) {
            synchronized (XIdSPUtils.class) {
                if (sInstance == null) {
                    sInstance = new XIdSPUtils();
                }
            }
        }
        return sInstance;
