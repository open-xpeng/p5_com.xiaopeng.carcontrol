...
public interface IVADEngine extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVADEngine {
        ...
        public static IVADEngine asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IVADEngine)) {
                return (IVADEngine) queryLocalInterface;
            }
