...
public class SupportRequestManagerFragment extends Fragment {
    ...
    private void registerFragmentWithRoot(FragmentActivity fragmentActivity) {
        ...
        SupportRequestManagerFragment supportRequestManagerFragment = Glide.get(fragmentActivity).getRequestManagerRetriever().getSupportRequestManagerFragment(fragmentActivity.getSupportFragmentManager(), null);
