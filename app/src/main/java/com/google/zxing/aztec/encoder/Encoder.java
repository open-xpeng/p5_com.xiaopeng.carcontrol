    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            while (i12 <= 32) {
                ...
                if (size2 <= i15) {
                    ...
                    int i17 = i15 - (i15 % i13);
                    if ((!z2 || bitArray2.getSize() <= i13 * 64) && bitArray2.getSize() + size <= i17) {
                        bitArray = bitArray2;
                        i3 = i13;
                        z = z2;
                        i4 = i14;
        ...
        if (z) {
            ...
            for (int i23 = i9; i23 < i21; i23++) {
                iArr2[(i21 - i23) - 1] = (i22 - i7) - 1;
                iArr2[i21 + i23] = (i23 / 15) + i23 + i22 + i10;
            }
        }
        ...
        while (i24 < i4) {
            ...
            while (i28 < i27) {
                int i29 = i28 * 2;
                while (i9 < i19) {
                    if (generateCheckWords.get(i25 + i29 + i9)) {
                        int i30 = i24 * 2;
                        bitMatrix.set(iArr2[i30 + i9], iArr2[i30 + i28]);
                    }
                    if (generateCheckWords.get((i27 * 2) + i25 + i29 + i9)) {
                        int i31 = i24 * 2;
                        bitMatrix.set(iArr2[i31 + i28], iArr2[((i18 - 1) - i31) - i9]);
                    }
                    if (generateCheckWords.get((i27 * 4) + i25 + i29 + i9)) {
                        int i32 = (i18 - 1) - (i24 * 2);
                        bitMatrix.set(iArr2[i32 - i9], iArr2[i32 - i28]);
                    }
                    if (generateCheckWords.get((i27 * 6) + i25 + i29 + i9)) {
                        int i33 = i24 * 2;
                        bitMatrix.set(iArr2[((i18 - 1) - i33) - i28], iArr2[i33 + i9]);
                    }
                    i9++;
                    i19 = 2;
                }
