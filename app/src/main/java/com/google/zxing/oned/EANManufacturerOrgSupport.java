...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{AssembleRequest.ASSEMBLE_ACTION_CANCEL, 440}, "DE");
            ...
            add(new int[]{560}, "PT");
            add(new int[]{569}, "IS");
            add(new int[]{570, 579}, GlobalConstant.COUNTRY.COUNTRY_DK);
            add(new int[]{590}, "PL");
            add(new int[]{594}, "RO");
            add(new int[]{599}, "HU");
            ...
            add(new int[]{690, 695}, GlobalConstant.COUNTRY.COUNTRY_CN);
            add(new int[]{TypedValues.Transition.TYPE_DURATION, 709}, GlobalConstant.COUNTRY.COUNTRY_NO);
            add(new int[]{729}, "IL");
            add(new int[]{730, 739}, GlobalConstant.COUNTRY.COUNTRY_SE);
            add(new int[]{740}, "GT");
            add(new int[]{741}, "SV");
            add(new int[]{742}, "HN");
            add(new int[]{743}, "NI");
            ...
            add(new int[]{870, 879}, GlobalConstant.COUNTRY.COUNTRY_NL);
            add(new int[]{880}, "KR");
            add(new int[]{885}, "TH");
            add(new int[]{888}, "SG");
            add(new int[]{890}, "IN");
