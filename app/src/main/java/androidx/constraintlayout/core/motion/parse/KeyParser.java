...
public class KeyParser {
    ...
    public static TypedBundle parseAttributes(String str) {
        return parse(str, new Ids() { // from class: androidx.constraintlayout.core.motion.parse.-$$Lambda$QPpZ2Y4pMMR_vXoAt_QnGY3_lnk
        ...
        }, new DataType() { // from class: androidx.constraintlayout.core.motion.parse.-$$Lambda$3WlMknFQFDplgY5IlOA5Hod5kQI
