...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                ...
                i9 = i2;
                i13 = (int) (findPreviousPosition.y * i9);
            ...
            if (findNextPosition != null) {
                int i20 = (int) (findNextPosition.x * i7);
                int i21 = (int) (findNextPosition.y * i9);
        ...
        int i22 = (int) (i5 + ((i14 - i6) * f5));
        widgetFrame.left = i22;
        int i23 = (int) (i13 + (f5 * (i15 - i13)));
        widgetFrame.top = i23;
        float f10 = 1.0f - f;
        widgetFrame.right = i22 + ((int) ((i3 * f10) + (i18 * f)));
        widgetFrame.bottom = i23 + ((int) ((f10 * i4) + (i19 * f)));
    ...
    void printCustomAttributes() {
        ...
        String str2 = (".(" + stackTraceElement.getFileName() + QuickSettingConstants.JOINER + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + " " + (hashCode() % 1000);
        if (this.widget != null) {
    ...
    void logv(String str) {
        String str2;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str3 = (".(" + stackTraceElement.getFileName() + QuickSettingConstants.JOINER + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + " " + (hashCode() % 1000);
        if (this.widget != null) {
