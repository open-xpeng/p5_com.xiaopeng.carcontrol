...
public class DependencyNode implements Dependency {
    ...
    public String toString() {
        return this.run.widget.getDebugName() + QuickSettingConstants.JOINER + this.type + "(" + (this.resolved ? Integer.valueOf(this.value) : "unresolved") + ") <t=" + this.targets.size() + ":d=" + this.dependencies.size() + ">";
    }
    ...
    public String name() {
        ...
        return str + QuickSettingConstants.JOINER + this.type.name();
    }
