...
public class LinearSystem {
    ...
    */
    ...
    void displaySystemInformation() {
        ...
        printStream.println(append.append(getDisplaySize(i5 * i5)).append(") -- row sizes: ").append(getDisplaySize(i)).append(", actual size: ").append(getDisplaySize(i3)).append(" rows: ").append(this.mNumRows).append(MqttTopic.TOPIC_LEVEL_SEPARATOR).append(this.mMaxRows).append(" cols: ").append(this.mNumColumns).append(MqttTopic.TOPIC_LEVEL_SEPARATOR).append(this.mMaxColumns).append(" ").append(0).append(" occupied cells, ").append(getDisplaySize(0)).toString());
    }
