    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", "top", "bottom", AccountConfig.FaceIDRegisterAction.STATUS_START, DMWait.STATUS_END}, -1);
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            this.writer.write(SPACE + name);
            this.writer.write(QuickSettingConstants.JOINER);
            int i = 0;
