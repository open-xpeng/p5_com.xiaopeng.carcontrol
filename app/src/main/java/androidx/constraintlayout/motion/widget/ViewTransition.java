...
public class ViewTransition {
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        layout.transitionToEnd(new Runnable() { // from class: androidx.constraintlayout.motion.widget.-$$Lambda$ViewTransition$R5MnrVoAl7eqn8MpswIds-XSqNs
    ...
    public /* synthetic */ void lambda$applyTransition$0$ViewTransition(final View[] views) {
        if (this.mSetsTag != -1) {
            for (View view : views) {
