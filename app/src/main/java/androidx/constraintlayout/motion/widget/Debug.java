...
public class Debug {
    public static void logStack(String tag, String msg, int n) {
        ...
        for (int i = 1; i <= min; i++) {
            ...
            str = str + " ";
            Log.v(tag, msg + str + (".(" + stackTrace[i].getFileName() + QuickSettingConstants.JOINER + stackTrace[i].getLineNumber() + ") " + stackTrace[i].getMethodName()) + str);
        }
    }
    ...
    public static void printStack(String msg, int n) {
        ...
        for (int i = 1; i <= min; i++) {
            StackTraceElement stackTraceElement = stackTrace[i];
            str = str + " ";
            System.out.println(msg + str + (".(" + stackTrace[i].getFileName() + QuickSettingConstants.JOINER + stackTrace[i].getLineNumber() + ") ") + str);
        }
    }
    ...
    public static void dumpPoc(Object obj) {
        ...
        String str = ".(" + stackTraceElement.getFileName() + QuickSettingConstants.JOINER + stackTraceElement.getLineNumber() + ")";
        Class<?> cls = obj.getClass();
        System.out.println(str + "------------- " + cls.getName() + " --------------------");
        for (Field field : cls.getFields()) {
            try {
                Object obj2 = field.get(obj);
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(Constant.DEFAULT_ERROR_RSC_ID)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static String getLocation() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + QuickSettingConstants.JOINER + stackTraceElement.getLineNumber() + ")";
    }
    ...
    public static void dumpLayoutParams(ViewGroup layout, String str) {
        Field[] fields;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str2 = ".(" + stackTraceElement.getFileName() + QuickSettingConstants.JOINER + stackTraceElement.getLineNumber() + ") " + str + "  ";
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (Field field : layoutParams.getClass().getFields()) {
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(Constant.DEFAULT_ERROR_RSC_ID)) {
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams param, String str) {
        ...
        for (Field field : param.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(Constant.DEFAULT_ERROR_RSC_ID)) {
