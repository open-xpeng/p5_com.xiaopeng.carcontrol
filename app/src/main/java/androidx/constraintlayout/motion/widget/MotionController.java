        ...
        while (true) {
            ...
            while (i15 < size) {
                if (motionPathsArr[i15].hasCustomData(str8)) {
                    ...
                    motionPathsArr[i15].getCustomData(str8, dArr3[i16], 0);
                    i16++;
                }
                i15++;
                i2 = 2;
            ...
            i14++;
            this.mSpline[i14] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr4, i16), (double[][]) Arrays.copyOf(dArr3, i16));
            i2 = 2;
            i = 0;
        }
