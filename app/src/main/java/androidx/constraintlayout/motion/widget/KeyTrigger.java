    ...
    private void fire(String str, View call) {
        ...
        if (method == null) {
            try {
                ...
                Log.e(TypedValues.Trigger.NAME, "Could not find method \"" + str + "\"on class " + call.getClass().getSimpleName() + " " + Debug.getName(call));
                return;
            }
        }
        try {
            ...
            Log.e(TypedValues.Trigger.NAME, "Exception in call \"" + this.mCross + "\"on class " + call.getClass().getSimpleName() + " " + Debug.getName(call));
        }
    }
