        ...
        try {
            ...
            while (true) {
                ...
                if (i2 >= length) {
                    ...
                    return new Typeface.CustomFallbackBuilder(builder.build()).setStyle(new FontStyle((i & 1) != 0 ? TypedValues.Transition.TYPE_DURATION : AssembleRequest.ASSEMBLE_ACTION_CANCEL, (i & 2) != 0 ? 1 : 0)).build();
                }
