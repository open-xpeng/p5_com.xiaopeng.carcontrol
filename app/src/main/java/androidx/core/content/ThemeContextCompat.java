...
public class ThemeContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            hashMap.put(ActivityManager.class, IScenarioController.SPACE_CAPSULE_SOURCE_ACTIVITY);
            hashMap.put(AlarmManager.class, NotificationCompat.CATEGORY_ALARM);
            hashMap.put(AudioManager.class, ListWidget.EXTRA_TYPE_AUDIO);
            ...
            hashMap.put(SearchManager.class, SpeechWidget.TYPE_SEARCH);
            hashMap.put(SensorManager.class, ContextSensor.DATA_SENSOR);
